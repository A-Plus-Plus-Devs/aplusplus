...
typedef enum
{
    ...
    NODE_FOR, // 16
    NODE_FUNCTION_DEFINITION, // 17
    NODE_FUNCTION_PARAMETER, // 18
    NODE_YIELD_STATEMENT, // 19
    NODE_FUNCTION_CALL, // 20
    NODE_COMPOUND_ASSIGN, // 21
    NODE_ARRAY_DECLARATION, // 22
    NODE_ARRAY_ACCESS, // 23
